        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              ...
              <li>The long-run growth engine for most portfolios.</li>
              <li>Own the global economy; diversify across regions and factors.</li>
              <li>Use rules to avoid emotion during drawdowns.</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5 text-sm text-white/80 space-y-1">
              <li>Long horizons (10+ years).</li>
              <li>During productivity/earnings growth regimes.</li>
              <li>When contributions are consistent and rebalanced.</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5 text-sm text-white/80 space-y-1">
              <li>Valuation risk (paying too much).</li>
              <li>Sequence-of-returns risk near retirement.</li>
              <li>Concentration risk (too much mega-cap).</li>
              </ul>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border hairline bg-white/5 p-4">
            ...
            <p className="mt-2 text-sm text-white/80">
              Use Equity as a <span className="font-medium">system component</span>, not a prediction tool.
